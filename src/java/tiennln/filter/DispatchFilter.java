...
public class DispatchFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        try {
            ...
            String actionMappingPath = realPath + "WEB-INF/" + "actionsMapping.properties";

            Properties prop = (Properties) context.getAttribute("ACTION_MAPPING_PROP");

            if (prop == null) {
                input = new FileInputStream(actionMappingPath);
                prop = new Properties();
                prop.load(input);

                context.setAttribute("ACTION_MAPPING_PROP", prop);
            }
            ...
            String action = prop.getProperty(resource);
