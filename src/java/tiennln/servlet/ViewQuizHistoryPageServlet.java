 ...
 * @author ADMIN
 */
@WebServlet(name = "ViewQuizHistoryPageServlet", urlPatterns = {"/ViewQuizHistoryPageServlet"})
public class ViewQuizHistoryPageServlet extends HttpServlet {

    private final Logger logger = Logger.getLogger(ViewQuizHistoryPageServlet.class);
        ...
        try {
            ...
            if (session != null) {
                ...
                if (lastUser != null) {
                    ...
                    List<QuizDTO> listQuizHistory = quizDAO.listAllQuizHistory(email);
